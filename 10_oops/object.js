...
function createUser(username, score) {
  this.username = username; // this sets a current context
  this.score = score;
}

createUser.prototype.increment = function () {
  this.score++; // jisne bhi isko bulaya hai uske paas jao
};
...
const aryan = new createUser("Aryan", 99);
const karan = new createUser("Karan", 100);
